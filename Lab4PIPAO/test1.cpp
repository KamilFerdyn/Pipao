...
void testDzialaniePlus() {
    ...
    cout << "Funkcja f3(1) = " << f3(1.0) << endl;  // Obliczanie wartości f3 dla x = 1
    cout << "Funkcja f3(2) = " << f3(2.0) << endl;  // Obliczanie wartości f3 dla x = 2
}
...
void testDzialanieRazy() {
    ...
    // Mnożenie funkcji: f1 * f2 = (2 * x + 3) * (x + 5)
    Funktor f3 = f1 * f2;
